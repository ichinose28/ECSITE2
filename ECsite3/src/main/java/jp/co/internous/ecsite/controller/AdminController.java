...
public class AdminController {
	...
	@Autowired
	private PostageTblMapper postageMapper;
	...
	@PostMapping("/postageMst")
	public String postageMst(LoginForm f, Model m) {
		m.addAttribute("userName", f.getUserName());
		m.addAttribute("password", f.getPassword());
	...
	@PostMapping("/addPostage")
	public String addPostage(PostageForm postageForm, LoginForm loginForm, Model m) {
		m.addAttribute("userName", loginForm.getUserName());
		m.addAttribute("password", loginForm.getPassword());
		
		PostageTbl postage = new PostageTbl();
		postage.setAddress(postageForm.getAddress());
		postage.setPostage(postageForm.getPostage());
